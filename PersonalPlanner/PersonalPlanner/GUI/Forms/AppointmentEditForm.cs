...
namespace PersonalPlanner.GUI.Forms
{
    ...
    /// </summary>
    public partial class AppointmentEditForm : DevExpress.XtraBars.Ribbon.RibbonForm, IDXManagerPopupMenu
    {
        #region Fields
        ...
        private SvgImage recurringSvgImage;
        private SvgImage normalSvgImage;
        private readonly AppointmentFormController controller;
        private IDXMenuManager menuManager;
        private bool supressCancelCore;
        ...
        public AppointmentEditForm(DevExpress.XtraScheduler.SchedulerControl control, Appointment apt)
            : this(control, apt, false)
        {
        }

        public AppointmentEditForm(DevExpress.XtraScheduler.SchedulerControl control, Appointment apt, bool openRecurrenceForm)
        {
        ...
        { get { return this.menuManager; } private set { this.menuManager = value; } }

        protected internal AppointmentFormController Controller
        { get { return this.controller; } }

        protected internal SchedulerControl Control
        { get { return this.control; } }

        protected internal ISchedulerStorage Storage
        { get { return this.storage; } }

        protected internal bool IsNewAppointment
        { get { return this.controller != null ? this.controller.IsNewAppointment : true; } }

        protected internal SvgImage RecurringSvgImage
        { get { return this.recurringSvgImage; } }

        protected internal SvgImage NormalSvgImage
        { get { return this.normalSvgImage; } }

        [Browsable(false), EditorBrowsable(EditorBrowsableState.Never), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public SvgImage SvgImage
        { get { return IconOptions.SvgImage; } set { IconOptions.SvgImage = value; } }

        protected internal bool OpenRecurrenceForm
        { get { return this.openRecurrenceForm; } }
        ...
        private void ExportAppointment(Stream stream)
        {
            if (stream == null)
                return;
